...
session_start();
 if($_SESSION['admin']==true){
    header("Location: http://eed13c9e9cce.eu.ngrok.io/prebuild-solutions/admin.php");
    exit;
   }
...
<head>
    ...
    <script src="/js/prebuild-solutions.js"></script>
</head>
<body>
    <!-- Header Start -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/prebuild-solutions/">Prebuilt Solutions</a>
                    </li>
                </ul>
